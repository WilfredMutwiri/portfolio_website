...
const currentProjects = [
  ...
  },
  {
    ...
    description: "Continuously improving and updating my portfolio with new projects and enhanced features.",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Current projects and contributions that keep me busy
          </p>
        </motion.div>
